...
// the control software. The target value is in the range [0-1024] which is
// mapped to the real voltage (analog read).
#define THC_ON_THRESHOLD 30

// The allowed diff between the target value and the actual value.
